const admin = {
  ...
  dataTable: {
    ...
    selectAllAria: "Select all rows on page",
    selectRowAria: "Select row",
    noResults: "No results",
    pageSummary: "{current} of {total}",
    showingEntries: "Showing {from}–{to} of {total}",
    filter: "Filter",
    export: "Export",
    exportCsv: "Export as CSV",
    exportExcel: "Export as Excel (soon)",
    exportPdf: "Export as PDF (soon)",
  },
  users: {
    title: "Users",
    ...
    addUserDescription:
      "We’ll send an email invite. If invites aren’t configured, an account is created — ask the user to set a password via “Forgot password”.",
    addUserSubmit: "Create user",
    addUserSuccess: "User created",
    addUserSuccessInvite: "Invite email sent",
    addUserSuccessCreate:
      "User created — ask them to reset password from the sign-in screen",
    addUserError: "Could not create user",
    formName: "Full name",
    formEmail: "Email",
    formPhone: "Phone (optional)",
    formRole: "Role",
    formNameError: "Enter a name",
    formEmailError: "Enter a valid email",
    formRoleError: "Select a role",
  },
  categories: {
    title: "Categories",
    addNew: "New Category",
